...
function accedi() {
    ...
    fetch('/login', {
        ...
        .then(data => {
            ...
            userDisplay.innerHTML = "Benvenuto " + data.user.username + ",<br>ecco il tuo massimo storico:<br>Normal mode: " + data.normalMaxScore + " pts.<br>Hardcore mode: " + data.hardcoreMaxScore + " pts.";
